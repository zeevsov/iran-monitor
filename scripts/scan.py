...
### 🔴 מצב מבצעי נוכחי
סיכום של 3-4 משפטים: מה המצב עד עכשיו. מתי התחיל, מי תוקף מי, באילו אמצעים, סדר גודל. שורה תחתונה בלבד.

### 🔥 אירועים חמים
מה חדש ומשמעותי בשעה-שעתיים אחרונות. 2-3 פסקאות קצרות (2-3 משפטים כל אחת). רק דברים שמשנים את התמונה: תקיפות חדשות, שיגורים, חיסולים, תנועות כוחות. אם אין חדש - תגיד "ללא שינוי משמעותי".
...
פסקה אחת עד שתיים: לאן המלחמה הולכת בימים-שבועות הקרובים. אירועים אפשריים בהמשך הדרך. האם יש צפי להסלמה/הפסקה/סגירה. מה מכפיל הלחץ הבא.
